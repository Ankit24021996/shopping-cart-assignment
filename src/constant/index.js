...
// Login message
export const loginTitleLabel = "Sign In Your Account";
export const loginDescriptionLabel =
  "Get access to your Orders, Whitelist and Recommendations.";
export const loginSubmitCtaLabel = "Log In";

// Register message
export const registerTitleLabel = "Create Your Account";
export const registerDescriptionLabel =
...
// Error Message for invaild field
export const emailInvaildErrorLabel = "Please provide vaild email address.";
export const passwordInvaildErrorLabel =
  "Password can not match our guidelines.";
